 ...
 *
 */
public class InterceptableDicomService extends AbstractDicomService {
    private List<DicomServiceInterceptor> interceptors = new ArrayList<DicomServiceInterceptor>();
    private final AbstractDicomService delegate;
    
    public InterceptableDicomService(AbstractDicomService delegate) {
        this.delegate = delegate;
    }
    
    public void addInterceptor(DicomServiceInterceptor interceptor) {
...
//        delegate.onDimseRQ(as, pc, dimse, cmd, data);
        
//        for(DicomServiceInterceptor interceptor : interceptors) {
//            interceptor.afterDimseRQ(as, pc, dimse, cmd, data);
//        }
    }
