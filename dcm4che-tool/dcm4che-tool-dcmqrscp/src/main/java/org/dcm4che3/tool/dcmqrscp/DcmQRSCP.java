...
public class DcmQRSCP<T extends InstanceLocator> {
    ...
    public final Device device = new Device("dcmqrscp");
    ...
    protected boolean stgCmtOnSameAssoc;
    ...
    protected HashMap<String, Connection> remoteConnections = new HashMap<String, Connection>();
...
//    private static void storeTo(Association as, Attributes fmi, PDVInputStream data,
...
//        serviceRegistry.addDicomService(new StgCmtSCPImpl());
    ...
    protected final DicomDirReader getDicomDirReader() {
        return ddReader;
    }
    
    public void setDicomDirWriter(DicomDirWriter ddWriter) {
        setDicomDirectory(ddWriter.getFile());
        this.ddReader = this.ddWriter = ddWriter;
    }
...
//    }
    ...
    static Attributes refSOP(String iuid, String cuid, int failureReason) {
